      ...
      <div>
         <header className="flex justify-between">
            ...
            <div className="md:flex hidden ">
               <Link to="../portfolio" className="md:text-xl text-xl text-white font-base font-title pr-10 text-opacity-75 hover:text-opacity-100" title="Portfolio" activeClassName='text-green-400 text-opacity-100 '>Portfolio</Link>
               <Link to="../about" className="md:text-xl text-xl text-white font-base font-title pr-10 text-opacity-75 hover:text-opacity-100" title="About" activeClassName='text-green-400 text-opacity-100 '>About</Link>
               <Link to="../contact" className="md:text-xl text-xl text-white font-base font-title text-opacity-75 hover:text-opacity-100" title="Contact" activeClassName='text-green-400 text-opacity-100 '>Contact</Link>
            </div>
