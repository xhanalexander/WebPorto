            ...
            <section className="flex flex-col justify-between mt-20">
               <article className="content-about text-white pattern-checks-sm bg-blue white">
                  ...
                  <p className="block md:text-xl text-base text-justify leading-6">
                     ...
                     <a href="https://p5js.org/" target="_blank" className="text-green-400 hover:text-white">&nbsp;p5Js</a> a javascript framework and 
                     <a href='https://openframeworks.cc/about/' target="_blank" className="text-green-400  hover:text-white"> Openframeworks&nbsp;</a> 
                     a C++ for creative coding.
                  </p>
                  <br />
                  <p className="block md:text-xl text-base text-justify leading-6">
                     Past project me and my brother worked on Music Videos artist
                     <a href="https://youtu.be/i0VDVqzVVEQ" target="_blank" className="text-green-400  hover:text-white">&nbsp;Bangkutaman</a>.
                     and digital advertising festival SevenFest SMAN 7 Jakarta (Senior Highschool 7 Jakarta) feature graffiti Artist.
                  </p>
               </article>
            </section>

            <section className="resume flex justify-center mt-10">
               <a href="https://drive.google.com/file/d/1ZunnJw7TC_SkyMcWDrgCMExnlEtjftY3/view?usp=sharing"  target="_blank" className="">
                  <button className="flex w-48 justify-center text-xl text-green-400 bg-transparent hover:bg-green-400 font-semibold hover:text-white py-2 px-4 border border-green-400 hover:border-transparent rounded-full m-auto tracking-wider" title="CV">
                     RESUME PDF
                  </button>
               </a>
            </section>
